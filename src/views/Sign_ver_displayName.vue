  ...
  data () {
    return {
      ...
      form: {
        ...
        birthdaySign: `${this.$store.state.monthSelect}. ${this.$store.state.daySelect}`
      }
    }
  },
  methods: {
    ...
    swapJoin () {
      ...
      if (this.swaplogin) {
        ...
        this.swapTitle = '회원가입'
        this.$store.commit('setDaySelect', 0)
        this.$store.commit('setMonthSelect', 0)
      }
