<template>
  <div class="sign">
    ...
    <div class="loginWrap" v-show="!swaplogin">
      <Input-Basic
        iptTitle="LOGIN EMAIL"
        @emailLoginRes="emailLoginCall"
        @emailLoginEff="emailLoginEffCall"
        iptType="text"
      />
      <Input-Basic
        iptTitle="LOGIN PASSWORD"
        @passwordLoginRes="passwordLoginCall"
        @passwordLoginEff="passwordLoginEffCall"
        iptType="password"
      />
    </div>

    <div class="signInWrap" v-show="swaplogin">
      <Input-Basic
        iptTitle="SIGN IN EMAIL"
        @emailSignRes="emailSignCall"
        @emailSignEff="emailSignEffCall"
        iptType="text"
      />
      <Input-Basic
        iptTitle="SIGN IN PASSWORD"
        @passwordSignRes="passwordSignCall"
        @passwordSignEff="passwordSignEffCall"
        iptType="password"
      />
      <Input-Basic
        iptTitle="FIRST NAME"
        iptType="text"
        @firstNameRes="firstNameCall"
        @firstNameEff="firstNameEffCall"
      />
      <Input-Basic
        iptTitle="LAST NAME"
        iptType="text"
        @lastNameRes="lastNameCall"
        @lastNameEff="lastNameEffCall"
      />
      <Input-Date
        iptTitle="BIRTHDAY"
        iptType="date"
        @birthdayRes="birthdayCall"
        @birthdayEff="birthdayEffCall"
      />
    </div>
    ...
    <div class="bottomWrap">
      ...
      <div class="btnLogin" v-if="!swaplogin">
        <button :disabled="btnLogInDisabled">로그인</button>
      </div>
      <div class="btnSignIn" v-if="swaplogin">
        <button :disabled="btnSignInDisabled">회원가입</button>
      </div>
    </div>
    ...
    <!-- Apple login button -->
    <div class="btnLoginApple" v-if="!swaplogin && stateIOS">
...
export default {
  ...
  methods: {
    ...
    emailLoginCall (value) {
      this.emailLoginR = value
    },
    passwordLoginCall (value) {
      this.passwordLoginR = value
    },
    emailSignCall (value) {
      this.emailSignR = value
    },
    passwordSignCall (value) {
      this.passwordSignR = value
    },
    firstNameCall (value) {
      this.firstNameR = value
    },
    lastNameCall (value) {
      this.lastNameR = value
    },
    birthdayCall (value) {
      this.birthdayR = value
    },
    emailLoginEffCall (value) {
      this.emailE = value
      this.effInterval()
    },
    passwordLoginEffCall (value) {
      this.passwordE = value
      this.effInterval()
    },
    emailSignEffCall (value) {
      this.emailE = value
      this.effInterval()
    },
    passwordSignEffCall (value) {
      this.passwordE = value
      this.effInterval()
    },
    firstNameEffCall (value) {
      this.firstNameE = value
      this.effInterval()
    },
    lastNameEffCall (value) {
      this.lastNameE = value
      this.effInterval()
    },
    birthdayEffCall (value) {
      this.birthdayE = value
      this.effInterval()
    },
    effInterval () {
      if (this.swaplogin) {
        if (this.emailE && this.passwordE && this.firstNameE && this.lastNameE && this.birthdayE) {
